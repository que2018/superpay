...
class QuickPayBRCViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if UserDefaults.standard.bool(forKey: "is_login") {
            ...
            if (UserDefaults.standard.string(forKey: "brc_card_hashed_number") != nil) {
    ...
    private func getEncyptedText() -> String {
        ...
        let payerCardNumber = UserDefaults.standard.string(forKey: "brc_card_hashed_number")!
