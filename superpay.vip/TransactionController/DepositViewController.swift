...
class DepositViewController: UITableViewController, IndicatorInfoProvider {
    
    let cellIdentifier = "DepositCell"
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tableView.register(UINib(nibName: "DepositCell", bundle: Bundle.main), forCellReuseIdentifier: cellIdentifier)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let depositCell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! DepositCell
        
        depositCell.nameLabel.text = transitions[indexPath.row].remitterName
        depositCell.dateTimeLabel.text = transitions[indexPath.row].updatedAt
        depositCell.amountLabel.text = "$" + String(transitions[indexPath.row].totalPay)
